...
const TextNextComponent = () => {
  return (
    <main className="w-full flex flex-col gap-4 divide-y-2 divide-dotted divide-accent border-1 border-accent p-4">
      <h1 className="centralized-start">Text Centralized Start</h1>
      <h1 className="centralized-center">Text Centralized Center</h1>
      <h1 className="centralized-end">Text Centralized End</h1>
      <h1 className="centralized-between">
        <span>Text</span>
        <span>Centralized</span>
        <span>Between</span>
      </h1>
      <h1 className="centralized-around">
        <span>Text</span>
        <span>Centralized</span>
        <span>Around</span>
      </h1>
