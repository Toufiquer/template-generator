...
import { useGetTestaQuery } from '@/app/string-array-example/redux/features/testa/testaSlice'
import Pagination from './Pagination'
import ExportDialog, { DataItem } from './ExportDialog' // Import the new dialog component

// Dynamically generated types for type safety
type DisplayableTestaKeys = 'title' | 'createdAt'
    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <ExportDialog
                ...
                data={bulkData as unknown as DataItem[]}
