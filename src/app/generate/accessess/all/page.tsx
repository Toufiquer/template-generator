...
import ViewAccessesTable from './components/TableView'
import BulkUpdateAccesses from './components/BulkUpdate'
import BulkDynamicUpdateAccesses from './components/BulkDynamicUpdate'
            ...
            <div className="flex flex-col md:flex-row gap-2 justify-between items-center mb-6">
                ...
                <div className="w-full flex flex-col md:flex-row gap-2 item-center justify-end">
                    <Button
                        ...
                        onClick={() =>
                            router.push('/dashboard/access/ssr-view')
                        }
                    >
                    ...
                    <Button
                        ...
                        variant="outlineGarden"
                        onClick={() =>
                            router.push('/dashboard/access/client-view')
                        }
                    >
                        <BiRightArrowAlt className="w-4 h-4" />
                        Client View
