...
import { useAddAccessesMutation } from '../redux/rtk-api'
...
const AddNextComponents: React.FC = () => {
    const { toggleAddModal, isAddModalOpen, setAccesses } = useAccessesStore()
    const [addAccesses, { isLoading }] = useAddAccessesMutation()
