...
import { useGetMvs2SummaryQuery } from '../redux/rtk-api'
...
/**
 * A component that displays a summary of mvs2 data in a dialog.
...
const Mvs2Summary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetMvs2SummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Mvs2 Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all mvs2 data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
