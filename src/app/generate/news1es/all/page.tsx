...
import ViewNews1esTable from './components/TableView'
import BulkUpdateNews1es from './components/BulkUpdate'
import BulkDynamicUpdateNews1es from './components/BulkDynamicUpdate'
