...
import { news1esSelectorArr } from '../store/store-constant'
                    ...
                    <div>
                        ...
                        <div className="w-full flex items-center justify-between pt-2">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (news1esSelectorArr[0] as string) || ''
                                }
                            >
                                ...
                                <SelectContent className="bg-slate-50">
                                    {news1esSelectorArr?.map((option, index) => (
                                        <SelectItem
                                            key={option + index}
                                            value={option}
                    ...
                    <div className="flex flex-col gap-2">
                        {bulkData.map((news1, idx) => (
                            ...
                            >
                                ...
                                <span className="text-blue-500">{news1['title1'] as string}</span>
                            </div>
                        ))}
                    </div>
                </ScrollArea>
