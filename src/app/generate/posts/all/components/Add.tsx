                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForString id="title" value={newPost['title']} onChange={(e) => handleFieldChange('title', e.target.value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForPassword id="password" value={newPost['password']} onChange={(e) => handleFieldChange('password', e.target.value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <Input
                            ...
                            onChange={(e) => handleFieldChange('books-list', e.target.value)}
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <MULTIOPTIONSField value={[newPost['check-list']]} onChange={(values) => handleFieldChange('check-list', values)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <RadioButtonGroupField value={newPost['shift']} onValueChange={(value) => handleFieldChange('shift', value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <MULTIOPTIONSField value={[newPost['ideas']]} onChange={(values) => handleFieldChange('ideas', values)} />
                            </div>
                        </div>
                    </div>
                </ScrollArea>
