                ...
                <ScrollArea className="h-[500px] w-full rounded-md border p-4">
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <SelectField value={editedPost['area']} onValueChange={(value) => handleFieldChange('area', value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <RadioButtonGroupField options={options} value={editedPost['shift']} onChange={(value) => handleFieldChange('shift', value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <MultiCheckboxGroupField value={editedPost['hobbys']} onChange={(values) => handleFieldChange('hobbys', values)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
