                ...
                {selectedPosts && (
                    <ScrollArea className="h-[500px] w-full rounded-md border p-4">
                        <div className="grid gap-1">
                            <DetailRow label="Student" value={selectedPosts['student']} />
                            <DetailRow label="Admin" value={selectedPosts['admin']} />
                            <DetailRow label="Moderator" value={selectedPosts['moderator']} />
                            <DetailRow label="Mentor" value={selectedPosts['mentor']} />
                            <DetailRow label="Instructor" value={selectedPosts['instructor']} />
