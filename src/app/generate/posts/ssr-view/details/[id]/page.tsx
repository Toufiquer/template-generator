...
const DataDetails = ({ data }: { data: IPost }) => {
    return (
        <div className="w-full flex flex-col md:p-4 p-1 gap-4">
            ...
            <div className="w-full hover:bg-slate-400 bg-slate-300 block p-2 border-b border-slate-400">
                <strong className="capitalize">books list:</strong> {data?.["books-list"]?.join(', ')}
            </div>
            <div className="w-full hover:bg-slate-400 bg-slate-300 block p-2 border-b border-slate-400">
                <strong className="capitalize">check list:</strong> {data?.["check-list"]?.join(', ')}
            </div>
            <div className="w-full hover:bg-slate-400 bg-slate-300 block p-2 border-b border-slate-400">
            ...
            <div className="w-full hover:bg-slate-400 bg-slate-300 block p-2 border-b border-slate-400">
                <strong className="capitalize">hobbys:</strong> {data?.["hobbys"]?.join(', ')}
            </div>
            <div className="w-full hover:bg-slate-400 bg-slate-300 block p-2 border-b border-slate-400">
