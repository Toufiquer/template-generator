...
import { useGetPostsbSummaryQuery } from '@/redux/features/postsb/postsbSlice'
...
/**
 * A component that displays a summary of postsb data in a dialog.
...
const PostsbSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetPostsbSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Postsb Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all postsb data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
