...
type Data = {
    ...
    "hobbies"?: string[];
    "ideas"?: string[];
    "students"?: Array<{ Name:STRING: string; Class:STRING: string; Roll:NUMBER: string }>;
    "complexValue"?: {
        "id"?: string;
        "title"?: string;
        "parent"?: {
...
const Page = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const url = `${baseUrl}/generate/postsb/all/api/v1?id=${id}`;
    ...
    if (loading) {
        return <div className="text-center p-8">Loading Postb details...</div>
    }
    ...
    if (!data) {
        return <div className="text-center p-8">No data available for this Postb.</div>
    }

    return (
        <div className="w-full flex flex-col md:p-4 p-1 gap-4">
            <h1 className="text-2xl font-bold">Postb Details</h1>
