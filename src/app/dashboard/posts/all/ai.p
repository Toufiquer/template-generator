I will give you two example of code one is responsive with sheet. another is not responsive as well. You have to update the second (without sheet) with responsive and implement sheet. also please implement glassimorphism effect. 
