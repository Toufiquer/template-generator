                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForString id="roleName" placeholder="RoleName" value={editedPost['roleName']} onChange={(value) => handleFieldChange('roleName', value as string)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-start gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <RichTextEditorField id="note" value={editedPost['note']} onChange={(value) => handleFieldChange('note', value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-start gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <RichTextEditorField id="description" value={editedPost['description']} onChange={(value) => handleFieldChange('description', value)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForEmail id="authorEmail" value={editedPost['authorEmail']} onChange={(value) => handleFieldChange('authorEmail', value as string)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-start gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <JsonTextareaField id="permission" value={editedPost['permission'] || {}} onChange={(value) => handleFieldChange('permission', value)} />
                            </div>
                        </div>
                    </div>
                </ScrollArea>
