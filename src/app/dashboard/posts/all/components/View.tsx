                ...
                {selectedPosts && (
                    <ScrollArea className="h-[500px] w-full rounded-md border p-4">
                        <div className="grid gap-1">
                            <DetailRow label="RoleName" value={selectedPosts['roleName']} />
                            <DetailRow label="Note" value={selectedPosts['note']} />
                            <DetailRow label="Description" value={selectedPosts['description']} />
                            <DetailRow label="AuthorEmail" value={selectedPosts['authorEmail']} />
                            <DetailRowJson label="Permission" value={selectedPosts['permission']} />
