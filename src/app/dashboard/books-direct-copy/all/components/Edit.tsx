...
import { useUpdateBooksMutation } from '../redux/rtk-Api'
import {
    ISelect_6_000___,
    booksSelectorArr,
    baseIBooks,
...
const EditNextComponents: React.FC = () => {
    ...
    useEffect(() => {
        if (selectedBooks) {
            ...
            setNewItemTags(selectedBooks.dataArr as string[])
            setNewImages(selectedBooks.images as string[])
        }
    }, [selectedBooks, setNewBooks])
