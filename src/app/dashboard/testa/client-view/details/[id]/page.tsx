...
const Page = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const url = `${baseUrl}/generate/testa/all/api/v1?id=${id}`;
    ...
    if (loading) {
        return <div className="text-center p-8">Loading Testa details...</div>
    }
    ...
    if (!data) {
        return <div className="text-center p-8">No data available for this Testa.</div>
    }
