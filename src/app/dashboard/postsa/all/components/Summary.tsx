...
import { useGetPostsaSummaryQuery } from '@/redux/features/postsa/postsaSlice'
...
/**
 * A component that displays a summary of postsa data in a dialog.
...
const PostsaSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetPostsaSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Postsa Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all postsa data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
