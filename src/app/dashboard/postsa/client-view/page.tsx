...
const Page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const url = `${baseUrl}/generate/postsa/all/api/v1?page=1&limit=10`;
    ...
    if (loading) {
        return <div className="text-center p-8">Loading Postsa...</div>
    }
    ...
    return (
        <main className="w-full flex flex-col gap-4 p-1 md:p-4">
            <h1 className="text-2xl font-bold">All Postsa</h1>
            {data.length > 0 ? (
