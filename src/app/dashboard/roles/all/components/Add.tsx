                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForString id="roleName" placeholder="RoleName" value={newRole['roleName']} onChange={(value) => handleFieldChange('roleName', value as string)} />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <InputFieldForEmail id="authorEmail" value={newRole['authorEmail']} onChange={(value) => handleFieldChange('authorEmail', value as string)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-start gap-4 pr-1">
                            ...
                            <div className="col-span-3">
                                <JsonTextareaField id="permission" value={(newRole['permission'] || '')} onChange={(value) => handleFieldChange('permission', value as string)} />
                            </div>
                        </div>
                    </div>
                </ScrollArea>
