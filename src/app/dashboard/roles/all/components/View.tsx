                ...
                {selectedRoles && (
                    <ScrollArea className="h-[500px] w-full rounded-md border p-4">
                        <div className="grid gap-1">
                            <DetailRow label="RoleName" value={selectedRoles['roleName']} />
                            <DetailRow label="Note" value={selectedRoles['note']} />
                            <DetailRow label="Description" value={selectedRoles['description']} />
                            <DetailRow label="AuthorEmail" value={selectedRoles['authorEmail']} />
                            <DetailRowJson label="Permission" value={selectedRoles['permission']} />
