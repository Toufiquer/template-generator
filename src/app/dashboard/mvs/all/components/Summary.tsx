...
/**
 * A component that displays a summary of mvs data in a dialog.
...
const MvsSummary = () => {
    ...
    const { data, isLoading, isError, isFetching } = useGetMvsSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Mvs Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all mvs data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
