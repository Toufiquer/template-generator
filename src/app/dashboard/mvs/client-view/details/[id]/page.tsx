...
const Page = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const url = `${baseUrl}/generate/mvs/all/api/v1?id=${id}`;
    ...
    if (loading) {
        return <div className="text-center p-8">Loading Mv details...</div>
    }
    ...
    if (!data) {
        return <div className="text-center p-8">No data available for this Mv.</div>
    }

    return (
        <div className="w-full flex flex-col md:p-4 p-1 gap-4">
            <h1 className="text-2xl font-bold">Mv Details</h1>
