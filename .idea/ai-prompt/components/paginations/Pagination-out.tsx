...
const Pagination: React.FC<PaginationProps> = ({
    ...
    const getPageNumbers = () => {
        ...
        return Array.from(
            { length: Math.min(maxPagesToShow, endPage - startPage + 1) },
            (_, i) => startPage + i
        )
    }
    ...
    return (
        <div className="flex items-center justify-center w-full py-4 ">
          ...
          `}
                ...
                {/* Start ellipsis */}
                {showStartEllipsis && (
                    <span className="flex items-center justify-center h-10 w-10 text-muted-foreground">
                        ...
                    </span>
                )}
                ...
                {pageNumbers.map((page) =>
                    renderPageButton(page, currentPage === page)
                )}
