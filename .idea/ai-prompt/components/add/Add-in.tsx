...
const AddNextComponents: React.FC = () => {
    ...
    const handleAddUsers_1_000___ = async () => {
        const Users_2_000___ = {
            ...
            role:
                (newUsers_1_000___.role as ISelect_6_000___) || select_5_000___,
            images: newImages || [],
        ...
        try {
            const addedUsers_1_000___ =
                await addUsers_1_000___(Users_2_000___).unwrap() // Get the returned data
                ...
                <ScrollArea className="h-[400px] w-full rounded-md border p-4">
                    <div className="grid gap-4 py-4">
                        <InputField
                            ...
                            name="name"
                            label="Name"
                            value={(newUsers_1_000___.name as string) || ''}
                        ...
                        <InputField
                            ...
                            name="alias"
                            label="Alias"
                            value={(newUsers_1_000___.alias as string) || ''}
                            onChange={handleInputChange}
                        />
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Select
                                ...
                                defaultValue={
                                    (newUsers_1_000___.role as string) || ''
                                }
                            >
