...
const DataDetails = ({ data }: { data: ITest2 }) => {
    return (
        <div className="w-full flex flex-col md:p-4 p-1 gap-4">
            <h1 className="text-2xl font-bold">Test2 Details</h1>
...
const getDataById = async (id: string): Promise<ApiResponse> => {
    const backendUrl = `http://localhost:3000/generate/test2s/all/api/v1?id=${id}`
    ...
    try {
        ...
        console.error('Failed to fetch Test2:', error)
        notFound();
    }
}
...
export async function generateMetadata({ params }: { params: { id: string } }) {
    ...
    return {
        title: data?.data?.["title"]?.toString() || 'Test2',
    }
}
