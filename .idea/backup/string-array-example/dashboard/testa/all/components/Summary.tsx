...
import { useGetTestaSummaryQuery } from '@/app/string-array-example/redux/features/testa/testaSlice'
...
/**
 * A component that displays a summary of testa data in a dialog.
...
const TestaSummary = () => {
    ...
    const { data, isLoading, isError } = useGetTestaSummaryQuery(
        { page, limit },
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Testa Summary</DialogTitle>
                    <DialogDescription>
                        An overview of all testa data, aggregated by month.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <strong>
                                        {summaryData.overall.totalRecords ??
                                            'N/A'}
                                    </strong>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <strong>
                                        {summaryData.overall.recordsLastMonth ??
                                            'N/A'}
                                    </strong>
                                </div>
                            </CardContent>
