...
const ViewNextComponents: React.FC = () => {
    ...
    const { data: Users_1_000___Data, refetch } = useGetUsers_1_000___ByIdQuery(
        selectedUsers_1_000___?._id,
        { skip: !selectedUsers_1_000___?._id }
    )
                        ...
                        <div className="w-full flex flex-col">
                            <div className="grid gap-2">
                                <DetailRow
                                    label="Name"
                                    value={
                                        selectedUsers_1_000___.name as string
                                    }
                                />
                                <DetailRow
                                    label="Email"
                                    value={
                                        selectedUsers_1_000___.email as string
                                    }
                                />
                                <DetailRow
                                    label="Pass Code"
                                    value={
                                        selectedUsers_1_000___.passCode as string
                                    }
                                />
                                <DetailRow
                                    label="Alias"
                                    value={
                                        selectedUsers_1_000___.alias as string
                                    }
                                />
                                <DetailRow
                                    label="Role"
                                ...
                                <DetailRowArray
                                    label="Data Array"
                                    values={
                                        selectedUsers_1_000___.dataArr as string[]
                                    }
                                />
                                <DetailRow
                                    label="Created At"
                                    value={formatDate(
                                        selectedUsers_1_000___.createdAt
                                    )}
                                />
                                <DetailRow
                                    label="Updated At"
                                    value={formatDate(
                                        selectedUsers_1_000___.updatedAt
                                    )}
                                />
                            </div>
                            <div className="w-full flex items-center justify-center mt-2 min-h-[10vh]">
                                {Array.isArray(selectedUsers_1_000___.images) &&
                                selectedUsers_1_000___.images?.length > 0 ? (
                                    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-1">
                                        {selectedUsers_1_000___.images.map(
                                            (i, index) => (
                                                <div
                                                    key={index + i}
                            ...
                            <ViewRichText
                                data={selectedUsers_1_000___.descriptions || ''}
                            />
                        </div>
                    </ScrollArea>
                )}
